...
# --- sanity: the publish module lives at the repo root ----------------------
if [ ! -f "$HERE/../overleaf-publish-module/index.mjs" ]; then
  echo "ERROR: overleaf-publish-module/ is missing at $HERE/../overleaf-publish-module" >&2
  exit 1
fi
